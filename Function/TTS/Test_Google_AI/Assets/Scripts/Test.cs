...
//                    if (text.Contains("¾Æ"))
//                        GameObject.Find("Cube").GetComponent<MeshRenderer>().material.color = new Color(255, 0, 0);
//                    else
//                        GameObject.Find("Cube").GetComponent<MeshRenderer>().material.color = new Color(255, 255, 255);
